...
open('playersdescription.csv', 'w')

# while loop to iterate through every player
while playersmin < playersmax:
    url = 'http://www.bkfrem.dk/default.asp?id=19&spillerid='+str(playersmin)
    ...
    csvfile.to_csv('playersdescription.csv', encoding='utf-8', mode='a', header=None, index=None)
    playersmin +=1
